...
export default function Paso2_Fundamentos({ estudianteNombre, respuestasDesafios, setRespuestasDesafios }: Paso2Props) {
  ...
  return (
    <div className="flex flex-col w-full max-w-6xl mx-auto p-6">
      ...
      {/* ENCABEZADO */}
      <div className="mb-6">
        <div className="text-blue-500 font-bold text-xs tracking-widest mb-2 uppercase">
          Estación 02
        </div>
        <h1 className="text-3xl lg:text-4xl font-extrabold text-white mb-3">
          Exploración de la Diversidad Microbiana y Celular
        </h1>
        
        <div className="bg-blue-900/30 border border-blue-500/50 p-3 rounded-lg flex items-center gap-3 w-full lg:w-3/4">
          <span className="text-xl">💡</span>
          <p className="text-blue-200 text-sm">
            <strong>Guía de uso:</strong> Navegue por las opciones haciendo clic en cada grupo biológico. Lea la descripción y digite la respuesta al "Desafío Rápido". Sus argumentos quedarán enlazados automáticamente a su perfil de usuario.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
          ...
          {especimenes.map((item, index) => (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                {respuestasDesafios[item.id]?.length > 10 && (
        ...
        <div className="flex-1 bg-slate-900/80 border border-slate-700/50 rounded-2xl p-6 flex flex-col lg:flex-row gap-6 shadow-xl">
          ...
          <div className="w-full lg:w-1/2 flex flex-col h-full justify-between">
            ...
            {/* CAJA DEL DESAFÍO CON ALERTA DE IDENTIFICACIÓN */}
            <div className="border border-amber-700/50 bg-amber-900/10 p-4 rounded-lg flex flex-col gap-3 relative">
              {!estudianteNombre && (
                <div className="absolute inset-0 bg-slate-950/90 backdrop-blur-sm rounded-lg z-10 flex flex-col items-center justify-center p-4 text-center">
                  ...
                  <p className="text-xs text-slate-400 mt-1">Por favor ingrese su nombre completo en la **Estación 01 (Bioseguridad)** para habilitar la casilla de respuestas.</p>
                </div>
              )}

              <div>
                <h4 className="text-amber-500 text-xs font-black uppercase tracking-widest mb-1">Desafío Rápido de Análisis</h4>
                <p className="text-amber-100/90 text-sm italic leading-tight">"{especimenActual.desafio}"</p>
              </div>
              ...
              <div className="relative">
                <textarea
                  ...
                  placeholder="Redacte su análisis de forma sintética aquí..."
